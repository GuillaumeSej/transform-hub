...
const en: Record<string, string> = {
  ...
  "leverDetail.trajectory.gains": "Annualized gains (recurring)",
  "leverDetail.trajectory.oneOffGains": "One-off gains (not counted)",
  "leverDetail.trajectory.opexRec": "Recurring OPEX (each period)",
  ...
  "chart.waterfall.increase": "Increase",
  "chart.waterfall.decrease": "Decrease",
  "chart.waterfall.note":
    "Expected total = reforecast − delays − costs. Cancelled initiatives excluded from totals.",
