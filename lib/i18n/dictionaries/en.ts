...
const en: Record<string, string> = {
  ...
  "validation.sa.kind.chantier_delete": "Workstream deletion",
  ...
  "adminHistory.entity.chantier": "Workstreams",
  ...
  "strategicAxes.tree.showChantiers": "View all workstreams",
  ...
  "strategicDelete.title.chantier": "Delete workstream",
  ...
  "strategicChantierDetail.successKpis.linkedHint":
    "Measurement indicators attached to this workstream's projects (excluding success criteria).",
  "strategicChantierDetail.successKpis.hint":
    "A success criterion = a KPI + the target value the workstream aims for.",
  ...
  "effectifs.needVsAvailable.empty":
    "No team to compare yet — declare staffing on a workstream or fill in the FTE roster.",
  ...
  "chart.gap.explain2":
    "The gap (reforecast − realized) is shown for the current period only. Click the chart for the breakdown by workstream.",
  "chart.scurveDetail.title": "Savings trajectory — detail",
  "chart.scurveDetail.byWorkstream": "Where savings come from (by workstream)",
  ...
  "chart.gapDrill.intro":
    "Cumulative gap at this period (initial plan − realized), split into an adjustment gap (initial plan − reforecast, over/under-performance) and a delay gap (reforecast − realized), by workstream or geography. Same rule as the curve: the sum of the rows = the gap shown.",
  ...
  "levers.tree.wsLead": "Workstream lead",
  "levers.tree.wsLeadEmpty": "Workstream lead not set",
