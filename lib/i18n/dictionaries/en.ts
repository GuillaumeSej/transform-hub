...
const en: Record<string, string> = {
  ...
  "shared.hrBreakdownCharts.caption":
    "Bars: FTE by movement type (above 0 = inflows, below = outflows). “net ±N”: net FTE balance of the group (hires − attrition − forced departures, transfers neutral). Hover a bar for details, click it for the list of movements.",
