...
const de: Record<string, string> = {
  ...
  "validation.realized.title": "Zu bestätigende Realisierungen",
  "validation.realized.intro":
    "Von Verantwortlichen als „Realisiert“ markierte Einsparungen oder Kosten zählen erst nach Bestätigung.",
  "validation.realized.impact": "Auswirkung",
  "validation.realized.amount": "Betrag",
  "validation.realized.approved": "Realisierung bestätigt",
  "validation.realized.rejected": "Realisierung abgelehnt",
  ...
  "validation.sa.step.current": "ausstehend",
  "validation.sa.step.rejected": "abgelehnt",
  "validation.sa.step.skipped": "nicht erreicht",
  "validation.sa.step.upcoming": "folgt",
  "validation.sa.field": "Feld",
  "validation.sa.field.name": "Name",
  "validation.sa.field.description": "Beschreibung",
  "validation.sa.field.start": "Startdatum",
  "validation.sa.field.end": "Enddatum",
  "validation.sa.field.status": "Status",
  "validation.sa.field.owner": "Projektverantwortlicher",
  "validation.sa.field.contributors": "Mitwirkende",
  "validation.sa.field.sponsor": "Sponsor",
  "validation.sa.field.deliverables": "Liefergegenstände",
  "validation.sa.field.prerequisites": "Voraussetzungen",
  "validation.sa.field.milestones": "Meilensteine / Checklisten",
  "validation.sa.field.customMilestoneActions": "Eigene Meilenstein-Aktionen",
  "validation.sa.field.excludedMilestoneItems": "Entfernte Meilenstein-Aktionen",
  "validation.sa.field.budget": "Budget",
  "validation.sa.field.consumedBudget": "Verbrauchtes Budget",
  "validation.sa.field.consumedFte": "Verbrauchte FTE",
  "validation.sa.field.chantierWeightPct": "Gewicht im Arbeitspaket (%)",
  "validation.sa.field.chantierId": "Übergeordnetes Arbeitspaket",
  "validation.sa.field.indicatorId": "Indikator",
  "validation.sa.field.allocatedBudget": "Budgetrahmen",
  "validation.sa.field.successKpis": "Erfolgs-KPIs",
  "validation.sa.field.successCriteria": "Erfolgskriterien",
  "validation.sa.field.effort": "Aufwandsraster",
  "validation.sa.field.axisIds": "Zugeordnete Achsen",
  "validation.sa.field.stage": "Stufe",
  "validation.sa.field.dependencies": "Abhängigkeiten",
  "validation.sa.field.pilote": "Arbeitspaket-Sponsor",
  "validation.sa.field.sponsorName": "Sponsor",
  "validation.sa.field.responsibleRoles": "Verantwortliche Rollen",
  "validation.sa.field.confidentialityLevel": "Vertraulichkeit",
  ...
  "roles.chantierOwner.label": "Arbeitspaket-Sponsor",
  "roles.chantierOwner.short": "AP-Sponsor",
  "roles.chantierContributor.label": "Projektverantwortlicher",
  "roles.chantierContributor.short": "Projektleitung",
  "roles.projetContributor.label": "Projektbeteiligter",
  "roles.projetContributor.short": "Projektbet.",
  ...
  "dashboard.widgets.healthShowAll": "Alle anzeigen",
  "dashboard.widgets.healthFilterHint": "Auf einen Status klicken, um zu filtern",
  ...
  "hr.alertsModal.alsoFlagged": "Außerdem: {kinds}",
  "hr.alertsBreakdown.segmentTip": "{label}: {n} Bewegung(en) ({pct} %) — Details anzeigen",
  "hr.alertsBreakdown.openAll": "Übersicht aller Bewegungen mit Warnung anzeigen",
  "hr.alertsBreakdown.note":
    "Jede Bewegung wird einmal gezählt, in ihrer schwerwiegendsten Kategorie.",
  "hr.alertsBreakdown.aria": "Aufteilung der Bewegungen mit Warnung",
  ...
  "hr.movementsRealizedDetailTitle": "Realisierte Bewegungen — {a}/{b}",
  "hr.movementsRealizedDetailHint": "Details der Bewegungen anzeigen",
  "hr.seeDetail": "Details anzeigen →",
  ...
  "admin.confidentiality.tab": "Vertraulichkeit",
  "admin.confidentiality.tabUsers": "Benutzer",
  "admin.confidentiality.company": "Unternehmen",
  "admin.confidentiality.loading": "Wird geladen…",
  "admin.confidentiality.emptyTitle": "Keine Stufe definiert — wenden Sie sich an BearingPoint",
  "admin.confidentiality.emptyBody":
    "Die Skala der Vertraulichkeitsstufen wird von BearingPoint bei der Einrichtung Ihres Unternehmens festgelegt.",
  "admin.confidentiality.scaleTitle": "Stufenskala",
  "admin.confidentiality.scaleDefinedBy": "Von BearingPoint bei der Einrichtung festgelegt",
  "admin.confidentiality.scaleHint":
    "Von der am wenigsten zur am stärksten eingeschränkten Stufe; eine Stufe gewährt Zugriff auf alle niedrigeren Stufen.",
  "admin.confidentiality.matrixTitle": "Standardstufe je Rolle",
  "admin.confidentiality.noRoles": "In diesem Unternehmen wird noch keine Rolle verwendet.",
  "admin.confidentiality.colRole": "Rolle",
  "admin.confidentiality.colUsers": "Benutzer",
  "admin.confidentiality.colLevel": "Standardstufe",
  "admin.confidentiality.levelNone": "Keine vertrauliche Stufe",
  "admin.confidentiality.matrixHint":
    "Administratoren haben immer vollen Zugriff. Ein Benutzer mit mehreren Rollen erbt die höchste Stufe.",
  "admin.confidentiality.trackPerformance": "Performance-Plan",
  "admin.confidentiality.trackStrategic": "Strategieplan",
  "admin.confidentiality.trackBoth": "Übergreifend",
  "admin.confidentiality.overridesTitle": "Individuelle Abweichungen",
  "admin.confidentiality.overridesEmpty":
    "Kein Benutzer hat eine individuelle Freigabe: alle erben die Stufe ihrer Rolle.",
  "admin.confidentiality.insteadOf": "statt",
  "admin.confidentiality.editInUsers": "In Benutzer bearbeiten",
  "admin.confidentiality.summaryAll": "Alle Stufen",
  "admin.confidentiality.summaryNone": "Kein Zugriff",
  "admin.confidentiality.summaryAdmin": "Administrator (voller Zugriff)",
  "admin.confidentiality.inheritWithLevel": "Von der Rolle erben (Stufe {level})",
  "admin.confidentiality.noLevel": "keine",
  "admin.confidentiality.savedTitle": "Freigaben gespeichert",
  "admin.confidentiality.savedBody": "Die Standardstufen der Rollen wurden aktualisiert.",
  "admin.confidentiality.saveError": "Speichern fehlgeschlagen",
  ...
  "adminUsers.clearanceNoLevelsCompany":
    "Für Ihr Unternehmen sind keine Vertraulichkeitsstufen definiert — wenden Sie sich an BearingPoint.",
  "admin.onboarding.companyAdmin.hintShort":
    "Noch kein Unternehmensadmin für diesen Kunden. Legen Sie den ersten Zugang an: Er verwaltet dann seine Benutzer und deren Vertraulichkeitsfreigaben.",
  "admin.onboarding.companyAdmin.create": "Unternehmensadmin anlegen",
  "adminCompanies.deleteConfirm":
    "Das Unternehmen „{name}“ endgültig löschen? Dies kann nicht rückgängig gemacht werden.",
  ...
  "strategicChantierDetail.sponsor": "COMEX-Sponsor",
  "strategicChantierDetail.pilote": "Arbeitspaket-Sponsor",
  ...
  "strategicChantierDetail.milestones.transition.waitingOwner":
    "Der Sponsor des Arbeitspakets muss den Übergang zu {milestone} bestätigen.",
  ...
  "strategicChantierDetail.milestones.transition.requestHint":
    "Der Sponsor des Arbeitspakets erhält den Antrag und muss den Übergang bestätigen.",
  ...
  "strategicImport.msg.responsibleRequired":
    '"Responsables saisie" ist ein Pflichtfeld (mindestens eine Person; ersatzweise "Rôles responsables")',
  "strategic.kpiResponsible.label": "Verantwortliche(r) für die Erfassung",
  "strategic.kpiResponsible.hint":
    "Mindestens eine namentlich benannte Person. Ebenfalls erfassen dürfen: der Planleiter, der Sponsor des Arbeitspakets (KPI eines Arbeitspakets) bzw. der Achse (KPI einer Achse) sowie Administratoren. COMEX-Mitglieder und HR erfassen nie.",
  "strategic.kpiResponsible.add": "Verantwortliche(n) hinzufügen…",
  "strategic.kpiResponsible.remove": "{name} entfernen",
  "strategic.kpiResponsible.legacyRoles":
    "Frühere Rollen (nur verwendet, solange niemand benannt ist):",
  "strategic.kpiResponsible.legacySuffix": "(alt, nach Rolle)",
  "strategic.kpiResponsible.clearLegacy": "Entfernen",
  ...
  "kpi.willBeValidatedBy": "Wird freigegeben von {chain}",
  "kpi.fillResponsibles": "Verantwortliche(r) für die Erfassung",
  "kpi.legacyByRole": "(alt, nach Rolle)",
  ...
  "strategicAxes.form.chantierOwner": "Arbeitspaket-Sponsor",
  ...
  "finance.hierarchyTable.col.late": "Verspätete Einsparungen",
  ...
  "strategicApprovals.phrase.projetCreateChantier":
    "das Hinzufügen des Projekts „{name}“ (Genehmigung durch den Arbeitspaket-Sponsor)",
  "strategicApprovals.phrase.projetCreateAxis":
    "das Hinzufügen des Projekts „{name}“ (Genehmigung durch den Achsen-Sponsor)",
  ...
  // ─── Mon espace (/me) ───
  "nav.myWorkspace": "Mein Bereich",
  "me.greeting": "Hallo {name}",
  "me.greetingAnonymous": "Hallo",
  "me.loading": "Ihr Bereich wird geladen…",
  "me.summary.nothing": "Keine offenen Aufgaben und keine anstehenden Fristen.",
  "me.summary.todoNone": "Keine offenen Aufgaben",
  "me.summary.todoOne": "{n} offene Aufgabe",
  "me.summary.todoMany": "{n} offene Aufgaben",
  "me.summary.late": ", davon {n} überfällig",
  "me.summary.upcomingNone": "keine Frist in den nächsten 4 Wochen",
  ...
  "me.category.blocked": "Bei anderen blockiert",
  "me.breakdown.itemsOne": "Element",
  "me.breakdown.itemsMany": "Elemente",
  "me.breakdown.hint": "Klicken Sie auf eine Kategorie, um die Seite zu filtern.",
  "me.breakdown.aria": "Aufteilung Ihrer Elemente nach Kategorie",
  "me.breakdown.segmentTip": "{label}: {n} ({pct} %) — zum Filtern klicken",
  "me.filter.active": "Filter: {label}",
  "me.filter.clear": "Filter entfernen",
  "me.todo.title": "Zu erledigen",
  "me.todo.emptyToHandle": "Keine weitere Aufgabe zu bearbeiten.",
  "me.todo.empty": "Derzeit nichts zu tun.",
  "me.todo.emptyHint": "Sie sind auf dem neuesten Stand.",
  "me.todo.emptyLate": "Keine überfällige Aufgabe.",
  "me.severity.critical": "Dringend",
  "me.severity.warning": "Zu bearbeiten",
  "me.severity.info": "Zu verfolgen",
  "me.due.late": "{n} T überfällig",
  "me.due.on": "fällig {date}",
  "me.blocked.title": "Bei anderen blockiert",
  "me.blocked.subtitle":
  ...
  "me.week.noDate": "Ohne Frist",
  "me.perimeter.title": "Mein Verantwortungsbereich",
  ...
  "me.item.projetCreateApproval": "Projekterstellung freigeben",
  "me.item.projetDeleteApproval": "Projektlöschung freigeben",
  "me.item.chantierDeleteApproval": "Löschung des Arbeitspakets freigeben",
  ...
  "me.item.measurementMissing": "Messwert {period} erfassen",
  "me.item.hrOverdue": "HR-Bewegung im Verzug",
  "me.item.hrDue": "HR-Bewegung fällig",
  "me.item.hrToValidate": "HR-Bewegung zu validieren",
  ...
  "admin.onboarding.statusDone": "Erledigt",
  "admin.onboarding.statusTodo": "Offen",
  "admin.onboarding.company.label": "Unternehmensbereich",
  "admin.onboarding.company.done": "Erstellt",
  "admin.onboarding.company.todo": "Zu erstellen",
  "admin.onboarding.company.action": "Einstellungen",
  "admin.onboarding.companyAdmin.label": "Unternehmensadmin",
  "admin.onboarding.companyAdmin.done": "{n} Admin-Konto/-Konten",
  "admin.onboarding.companyAdmin.todo": "Noch kein Kundenzugang",
  "admin.onboarding.companyAdmin.action": "Zugang erstellen",
  "admin.onboarding.companyAdmin.hint":
    "Für diesen Kunden gibt es noch keinen Unternehmensadmin. Erstellen Sie den ersten Zugang: unten „Hinzufügen“ klicken und „Unternehmensadmin“ ankreuzen. Dieser verwaltet dann seine Benutzer und deren Vertraulichkeitsfreigaben.",
  "admin.onboarding.settings.label": "Grundeinstellungen",
  "admin.onboarding.settings.done": "{n} Programm(e) konfiguriert",
  "admin.onboarding.settings.todo": "Kein Programm konfiguriert",
  "admin.onboarding.settings.action": "Programme",
  "admin.onboarding.confidentiality.label": "Vertraulichkeitsstufen",
  "admin.onboarding.confidentiality.done": "{n} Stufe(n) definiert",
  "admin.onboarding.confidentiality.todo": "Skala nicht definiert",
  "admin.onboarding.confidentiality.action": "Skala definieren",
  "admin.onboarding.strategicPlan.label": "Strategieplan",
  "admin.onboarding.strategicPlan.done": "{n} Achse(n) importiert",
  "admin.onboarding.strategicPlan.todo": "Keine Achse importiert",
  "admin.onboarding.strategicPlan.action": "Importieren (Excel)",
  "admin.onboarding.levels.orderHint":
    "Reihenfolge = Hierarchie: Ein für eine Stufe freigegebenes Profil sieht auch die darüberliegenden Stufen. Der Unternehmensadmin entscheidet anschließend, wer welche Stufe sieht.",
  "admin.onboarding.levels.usedBy": "Von {n} Element(en) verwendet",
  "admin.onboarding.levels.moveUp": "Nach oben",
  "admin.onboarding.levels.moveDown": "Nach unten",
  "admin.onboarding.levels.rename": "Umbenennen",
  "admin.onboarding.levels.renameWarning":
    "{n} Element(e) tragen diese Stufe und werden nicht umbenannt: Sie werden für Nicht-Admin-Profile unsichtbar, bis sie neu zugeordnet werden.",
  "admin.onboarding.levels.removeWarning":
    "„{level}“ wird von {n} Element(en) verwendet (Initiativen, Achsen, Arbeitspakete, Indikatoren oder Freigaben). Nach dem Entfernen werden diese Elemente für Nicht-Admin-Profile unsichtbar, bis eine Stufe neu zugeordnet wird.",
  "admin.onboarding.levels.removeAnyway": "Trotzdem entfernen",
  // ─── profile (page « Mon profil ») ───────────────────────────────────────
  "profile.title": "Mein Profil",
  "profile.subtitle":
    "Ihre Kontoinformationen. Wenden Sie sich für Änderungen an Ihren Administrator.",
  "profile.open": "Mein Profil anzeigen",
  "profile.logout": "Abmelden",
  "profile.infoTitle": "Informationen",
  ...
  "profile.direction": "Bereich",
  "profile.profiles": "Profile",
  "profile.noProfile": "Kein fachliches Profil",
  "profile.allPrograms": "Alle Programme",
  "profile.adminRights": "Administrationsrechte",
  "profile.noAdminRights": "Keine",
  "profile.adminGlobal": "BearingPoint-Admin",
  "profile.adminCompany": "Unternehmens-Admin",
  "profile.clearance": "Vertraulichkeitsstufe",
  "profile.clearanceAdmin": "Vollzugriff (Administrator)",
  "profile.clearanceAll": "Alle Stufen",
  "profile.clearanceLevel": "{level} (und niedrigere Stufen)",
  "profile.clearanceNone": "Keine vertrauliche Stufe",
  "profile.clearanceIndividual": "Individuelle Freigabe",
  "profile.clearanceInherited": "Von Ihren Profilen übernommen",
  "profile.password.title": "Passwort",
  "profile.password.current": "Aktuelles Passwort",
  "profile.password.next": "Neues Passwort",
  "profile.password.confirm": "Neues Passwort bestätigen",
  "profile.password.hint": "Mindestens {n} Zeichen.",
  "profile.password.submit": "Passwort ändern",
  "profile.password.saving": "Wird geändert…",
  "profile.password.successTitle": "Passwort geändert",
  "profile.password.successBody": "Verwenden Sie Ihr neues Passwort bei der nächsten Anmeldung.",
  "profile.password.errorCurrentRequired": "Geben Sie Ihr aktuelles Passwort ein.",
  "profile.password.errorNextRequired": "Geben Sie ein neues Passwort ein.",
  "profile.password.errorTooShort": "Das Passwort muss mindestens {n} Zeichen enthalten.",
  "profile.password.errorSameAsCurrent": "Das neue Passwort muss sich vom aktuellen unterscheiden.",
  "profile.password.errorMismatch": "Die Bestätigung stimmt nicht mit dem neuen Passwort überein.",
  "profile.password.errorWrongCurrent": "Das aktuelle Passwort ist falsch.",
  "profile.password.errorWeak": "Dieses Passwort ist zu schwach. Wählen Sie ein längeres.",
  "profile.password.errorTooMany": "Zu viele Versuche. Versuchen Sie es in einigen Minuten erneut.",
  "profile.password.errorRecentLogin":
    "Ihre Sitzung ist abgelaufen. Melden Sie sich ab und wieder an, bevor Sie es erneut versuchen.",
  "profile.password.errorNetwork":
    "Netzwerk nicht verfügbar. Prüfen Sie Ihre Verbindung und versuchen Sie es erneut.",
  "profile.password.errorGeneric":
    "Das Passwort konnte nicht geändert werden. Versuchen Sie es später erneut.",
  // Gestion des comptes par l'admin (désactivation, lien de réinitialisation, e-mail)
  "login.errorDisabled":
    "Dieses Konto wurde deaktiviert. Wenden Sie sich an den Administrator Ihres Unternehmens, um es zu reaktivieren.",
  "adminUsers.emailInvalid": "Ungültige E-Mail-Adresse (z. B. vorname.nachname@firma.com).",
  "adminUsers.emailInvalidTitle": "Ungültige E-Mail",
  "adminUsers.fieldEmail": "Kontakt-E-Mail (optional)",
  "adminUsers.emailPlaceholder": "vorname.nachname@firma.com",
  "adminUsers.passwordModeLink":
    "Link generieren, damit der Benutzer sein Passwort selbst festlegt (empfohlen)",
  "adminUsers.passwordModeManual": "Temporäres Anfangspasswort festlegen",
  "adminUsers.createdTitle": "Benutzer erstellt",
  "adminUsers.createdManualBody":
    "Das Konto „{username}“ wurde mit dem eingegebenen Anfangspasswort erstellt. Bitten Sie den Benutzer, es unter „Mein Profil“ zu ändern.",
  "adminUsers.resetLinkFailed": "Link konnte nicht generiert werden",
  "adminUsers.resetLinkFailedNewAccount":
    "Das Konto wurde erstellt. Generieren Sie den Link später über die Aktion „Passwort zurücksetzen“.",
  "adminUsers.copyFailed": "Kopieren nicht möglich",
  "adminUsers.copyFailedBody": "Markieren Sie den Link und kopieren Sie ihn manuell.",
  "adminUsers.disableBlockedTitle": "Deaktivierung nicht möglich",
  "adminUsers.disableBlockedSelf": "Sie können Ihr eigenes Konto nicht deaktivieren.",
  "adminUsers.disableBlockedLastAdmin":
    "Der letzte aktive Administrator des Unternehmens kann nicht deaktiviert werden. Ernennen Sie zuerst einen anderen Administrator.",
  "adminUsers.disablePartialTitle": "Status teilweise aktualisiert",
  "adminUsers.disablePartialBody":
    "Der Status wurde in der Anwendung gespeichert, das Anmeldekonto konnte jedoch nicht synchronisiert werden ({error}). Versuchen Sie es später erneut.",
  "adminUsers.disabledTitle": "Benutzer deaktiviert",
  "adminUsers.enabledTitle": "Benutzer reaktiviert",
  "adminUsers.disabledBody": "Das Konto „{username}“ kann sich nicht mehr anmelden.",
  "adminUsers.enabledBody": "Das Konto „{username}“ kann sich wieder anmelden.",
  "adminUsers.disableFailed": "Deaktivierung fehlgeschlagen",
  "adminUsers.enableFailed": "Reaktivierung fehlgeschlagen",
  ...
  "adminUsers.badgeDisabled": "Deaktiviert",
  "adminUsers.resetPassword": "Passwort zurücksetzen",
  "adminUsers.enableUser": "Reaktivieren",
  "adminUsers.disableUser": "Deaktivieren",
  "adminUsers.confirmDisableTitle": "Benutzer deaktivieren?",
  "adminUsers.confirmEnableTitle": "Benutzer reaktivieren?",
  "adminUsers.confirmDisableBody":
    "Das Konto „{username}“ kann sich nicht mehr anmelden, offene Sitzungen werden beendet. Konto und Verlauf bleiben erhalten; Sie können es jederzeit reaktivieren.",
  "adminUsers.confirmEnableBody":
    "Das Konto „{username}“ kann sich wieder mit seinem aktuellen Passwort anmelden.",
  "adminUsers.resetLinkNewTitle": "Benutzer erstellt – Aktivierungslink",
  "adminUsers.resetLinkTitle": "Link zum Zurücksetzen des Passworts",
  "adminUsers.close": "Schließen",
  "adminUsers.resetLinkBody":
    "Senden Sie diesen Link an „{username}“: Damit legt der Benutzer sein Passwort selbst fest. Er ist nur einmal gültig und läuft nach begrenzter Zeit ab. Sie sehen das Passwort nie.",
  "adminUsers.resetLinkLabel": "Link zum Zurücksetzen",
  "adminUsers.linkCopied": "Link kopiert",
  "adminUsers.copyLink": "Link kopieren",
  "adminUsers.sendByEmail": "Per E-Mail an {email} senden",
  "adminUsers.resetLinkNoEmail":
    "Für diesen Benutzer ist keine Kontakt-E-Mail hinterlegt: Kopieren Sie den Link und übermitteln Sie ihn über einen sicheren Kanal.",
  "adminHistory.account.renameUser": "Umbenennung",
  "adminHistory.account.deleteUser": "Löschung",
  "adminHistory.account.disableUser": "Deaktivierung",
  "adminHistory.account.enableUser": "Reaktivierung",
  "adminHistory.account.passwordResetLink": "Link zum Zurücksetzen",
  "adminHistory.account.actor": "Von",
  "adminHistory.account.target": "Konto",
  "adminHistory.company": "Unternehmen",
  "adminHistory.accountTitle": "Aktionen an Benutzerkonten",
  "adminHistory.accountEmpty": "Keine Kontoaktionen.",
  ...
  "strategicFiche.contributors.label": "Mitwirkende",
  "strategicFiche.contributors.none": "Keine Mitwirkenden",
  "strategicFiche.contributors.remove": "Entfernen",
  "strategicFiche.contributors.add": "+ Mitwirkende hinzufügen",
  "strategicFiche.pending.badge": "Freigabe ausstehend",
  "strategicFiche.pending.badgeStep": "Freigabe ausstehend (Schritt {current}/{total})",
  "strategicFiche.pending.waitingFor": "Bei {names}",
  "strategicFiche.pending.proposedValue": "Vorgeschlagener Wert: {value}",
  "strategicFiche.pending.conflictTooltip":
    "Für dieses Feld ist bereits eine Freigabe ausstehend: Warten Sie die Entscheidung ab, bevor Sie es erneut ändern.",
  "strategicFiche.pending.conflictTitle": "Freigabe bereits ausstehend",
  "strategicFiche.pending.chantierCreation": "Anlage wartet auf Freigabe",
  "strategicFiche.draft.title": "Nicht gesendete Änderungen",
  "strategicFiche.draft.conflict": "Freigabe bereits ausstehend: {fields}",
  "strategicFiche.draft.submit": "Zur Freigabe senden",
  "strategicFiche.draft.discard": "Änderungen verwerfen",
  "strategicFiche.draft.projetsCount": "{count} Projekte mit nicht gesendeten Änderungen",
  "strategicFiche.draft.submitAll": "Alle senden",
  "strategicFiche.draft.discardAll": "Alle verwerfen",
  "strategicFiche.rights.projectOwner":
    "Die Projektverantwortung wird vom Sponsor des Arbeitspakets (oder höher) festgelegt.",
  "strategicFiche.rights.contributors":
    "Mitwirkende werden von der Projektverantwortung (oder höher) festgelegt.",
  "strategicFiche.rights.chantierSponsor":
    "Der Sponsor des Arbeitspakets wird von der Planleitung (oder einem Administrator) festgelegt.",
  "strategicFiche.rights.axisSponsor":
    "Der Sponsor der Achse wird von der Planleitung (oder einem Administrator) festgelegt.",
  "strategicFiche.rights.projetEdit":
    "Nur die Projektverantwortung, die Mitwirkenden und höhere Ebenen können es bearbeiten.",
