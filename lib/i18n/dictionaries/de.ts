...
const de: Record<string, string> = {
  ...
  "staffing.hint": "Eine Zeile je beteiligter Funktion. Dezimalwerte möglich (0,5 = halbtags).",
  ...
  "staffing.function.finance": "Finanzen",
  "staffing.function.it": "IT",
  "staffing.function.marketing": "Marketing",
  "staffing.function.commercial": "Vertrieb",
  "staffing.function.juridique": "Recht",
  ...
  "effectifs.clickHint": "Klicken Sie auf eine Funktion, um ihre Verteilung nach Achse zu sehen.",
  "effectifs.percentOfFunction": "% der Funktion",
