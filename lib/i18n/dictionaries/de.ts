...
const de: Record<string, string> = {
  ...
  "leverDetail.trajectory.gains": "Annualisierte Gewinne (wiederkehrend)",
  "leverDetail.trajectory.oneOffGains": "Einmalige Gewinne (nicht gezählt)",
  "leverDetail.trajectory.opexRec": "Wiederkehrender OPEX (pro Periode)",
  ...
  "chart.waterfall.increase": "Anstieg",
  "chart.waterfall.decrease": "Rückgang",
  "chart.waterfall.note":
    "Erwartete Summe = Neuprognose − Verzögerungen − Kosten. Stornierte Hebel sind aus den Summen ausgeschlossen.",
