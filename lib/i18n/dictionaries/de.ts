...
const de: Record<string, string> = {
  ...
  "validation.sa.kind.chantier_delete": "Workstream-Löschung",
  ...
  "roles.cto.short": "CTO",
  "roles.sponsor.label": "Workstream-Leiter",
  "roles.sponsor.short": "Leiter",
  "roles.programSponsor.label": "Programm-Sponsor",
  "roles.programSponsor.short": "Sponsor",
  "roles.programOwner.label": "Programm-Owner",
  "roles.programOwner.short": "Owner",
  ...
  "staffing.empty": "Für dieses Vorhaben sind keine VZÄ erfasst.",
  ...
  "effectifs.subtitle":
    "In den Vorhaben des Programms eingesetzte VZÄ nach Team. Klicken Sie auf ein Team, um seine Verteilung über die Achsen zu sehen und mögliche Überbesetzung zu erkennen.",
  ...
  "effectifs.needVsAvailable.empty":
    "Noch kein Team zum Vergleichen — erfassen Sie Personaleinsatz auf einem Vorhaben oder befüllen Sie die VZÄ-Basis.",
  ...
  "effectifs.needVsAvailable.periodHintAvg":
    "Durchschnittliche VZÄ über {period} (Zeilen mit Datumsüberschneidung, nach Dauer gewichtet). Verfügbar: aktueller Stand der VZÄ-Basis. Mobilisiert: bis heute verstrichener Anteil des Bedarfs; Staffing = mobilisiert / Bedarf.",
  ...
  "levers.tree.wsLead": "Workstream-Leiter",
  "levers.tree.wsLeadEmpty": "Workstream-Leiter nicht angegeben",
  ...
  "chart.gap.explain2":
    "Die Abweichung (Neuprognose − realisiert) wird nur für die aktuelle Periode angezeigt. Klicken Sie auf das Diagramm für die Aufschlüsselung nach Workstream.",
  "chart.scurveDetail.title": "Einsparungsverlauf — Details",
  "chart.scurveDetail.byWorkstream": "Woher die Einsparungen kommen (nach Workstream)",
