...
const fr: Record<string, string> = {
  ...
  "admin.confidentiality.tab": "Confidentialité",
  "admin.confidentiality.tabUsers": "Utilisateurs",
  "admin.confidentiality.company": "Entreprise",
  "admin.confidentiality.loading": "Chargement…",
  "admin.confidentiality.emptyTitle": "Aucun niveau défini — contactez BearingPoint",
  ...
  "admin.confidentiality.scaleTitle": "Échelle des niveaux",
  "admin.confidentiality.scaleDefinedBy": "Défini par BearingPoint lors de la mise en place",
  "admin.confidentiality.scaleHint":
    "Du moins au plus restreint ; un niveau donne accès à tous les niveaux inférieurs.",
  "admin.confidentiality.matrixTitle": "Niveau par défaut de chaque rôle",
  "admin.confidentiality.noRoles": "Aucun rôle utilisé dans cette entreprise pour l'instant.",
  "admin.confidentiality.colRole": "Rôle",
  "admin.confidentiality.colUsers": "Utilisateurs",
  "admin.confidentiality.colLevel": "Niveau par défaut",
  "admin.confidentiality.levelNone": "Aucun niveau confidentiel",
  ...
  "admin.confidentiality.trackPerformance": "Plan de performance",
  "admin.confidentiality.trackStrategic": "Plan stratégique",
  "admin.confidentiality.trackBoth": "Transverse",
  "admin.confidentiality.overridesTitle": "Surcharges individuelles",
  ...
  "admin.confidentiality.insteadOf": "au lieu de",
  "admin.confidentiality.editInUsers": "Modifier dans Utilisateurs",
  "admin.confidentiality.summaryAll": "Tous les niveaux",
  "admin.confidentiality.summaryNone": "Aucun accès",
  "admin.confidentiality.summaryAdmin": "Administrateur (accès total)",
  "admin.confidentiality.inheritWithLevel": "Hérite du rôle (niveau {level})",
  "admin.confidentiality.noLevel": "aucun",
  "admin.confidentiality.savedTitle": "Habilitations enregistrées",
  "admin.confidentiality.savedBody": "Les niveaux par défaut des rôles ont été mis à jour.",
  "admin.confidentiality.saveError": "Échec de l'enregistrement",
  ...
  "admin.onboarding.companyAdmin.create": "Créer l'admin entreprise",
  ...
  "admin.onboarding.statusDone": "Fait",
  "admin.onboarding.statusTodo": "À faire",
  "admin.onboarding.company.label": "Espace entreprise",
  "admin.onboarding.company.done": "Créé",
  "admin.onboarding.company.todo": "À créer",
  "admin.onboarding.company.action": "Paramètres",
  "admin.onboarding.companyAdmin.label": "Admin entreprise",
  "admin.onboarding.companyAdmin.done": "{n} compte(s) admin",
  "admin.onboarding.companyAdmin.todo": "Aucun accès client créé",
  "admin.onboarding.companyAdmin.action": "Créer l'accès",
  "admin.onboarding.companyAdmin.hint":
    "Aucun admin d'entreprise pour ce client. Créez son premier accès : « Ajouter » ci-dessous, puis cochez « Admin entreprise ». Il gérera ensuite ses utilisateurs et leurs habilitations de confidentialité.",
  "admin.onboarding.settings.label": "Paramétrage initial",
  "admin.onboarding.settings.done": "{n} programme(s) configuré(s)",
  "admin.onboarding.settings.todo": "Aucun programme configuré",
  "admin.onboarding.settings.action": "Programmes",
  "admin.onboarding.confidentiality.label": "Niveaux de confidentialité",
  "admin.onboarding.confidentiality.done": "{n} niveau(x) défini(s)",
  "admin.onboarding.confidentiality.todo": "Échelle non définie",
  "admin.onboarding.confidentiality.action": "Définir l'échelle",
  "admin.onboarding.strategicPlan.label": "Plan stratégique",
  "admin.onboarding.strategicPlan.done": "{n} axe(s) importé(s)",
  "admin.onboarding.strategicPlan.todo": "Aucun axe importé",
  "admin.onboarding.strategicPlan.action": "Importer (Excel)",
  ...
  "admin.onboarding.levels.usedBy": "Utilisé par {n} élément(s)",
  "admin.onboarding.levels.moveUp": "Monter",
  "admin.onboarding.levels.moveDown": "Descendre",
  "admin.onboarding.levels.rename": "Renommer",
  ...
  "admin.onboarding.levels.removeAnyway": "Retirer quand même",
  // ─── profile (page « Mon profil ») ───────────────────────────────────────
  "profile.title": "Mon profil",
  "profile.subtitle":
    "Vos informations de compte. Pour les modifier, contactez votre administrateur.",
  "profile.open": "Voir mon profil",
  "profile.logout": "Se déconnecter",
  "profile.infoTitle": "Informations",
  ...
  "profile.noProfile": "Aucun profil métier",
  "profile.allPrograms": "Tous les programmes",
  "profile.adminRights": "Habilitations d'administration",
  "profile.noAdminRights": "Aucune",
  "profile.adminGlobal": "Admin BearingPoint",
  "profile.adminCompany": "Admin entreprise",
  "profile.clearance": "Niveau de confidentialité",
  "profile.clearanceAdmin": "Accès total (administrateur)",
  "profile.clearanceAll": "Tous les niveaux",
  "profile.clearanceLevel": "{level} (et les niveaux inférieurs)",
  "profile.clearanceNone": "Aucun niveau confidentiel",
  "profile.clearanceIndividual": "Habilitation individuelle",
  "profile.clearanceInherited": "Héritée de vos profils",
  "profile.password.title": "Mot de passe",
  "profile.password.current": "Mot de passe actuel",
  "profile.password.next": "Nouveau mot de passe",
  "profile.password.confirm": "Confirmer le nouveau mot de passe",
  "profile.password.hint": "Au moins {n} caractères.",
  "profile.password.submit": "Modifier le mot de passe",
  "profile.password.saving": "Modification…",
  "profile.password.successTitle": "Mot de passe modifié",
  "profile.password.successBody":
    "Utilisez votre nouveau mot de passe lors de votre prochaine connexion.",
  "profile.password.errorCurrentRequired": "Saisissez votre mot de passe actuel.",
  "profile.password.errorNextRequired": "Saisissez un nouveau mot de passe.",
  "profile.password.errorTooShort": "Le mot de passe doit contenir au moins {n} caractères.",
  "profile.password.errorSameAsCurrent": "Le nouveau mot de passe doit être différent de l'actuel.",
  "profile.password.errorMismatch": "La confirmation ne correspond pas au nouveau mot de passe.",
  "profile.password.errorWrongCurrent": "Le mot de passe actuel est incorrect.",
  "profile.password.errorWeak": "Ce mot de passe est trop faible. Choisissez-en un plus long.",
  "profile.password.errorTooMany": "Trop de tentatives. Réessayez dans quelques minutes.",
  ...
  "profile.password.errorGeneric": "Le mot de passe n'a pas pu être modifié. Réessayez plus tard.",
  ...
  "adminUsers.emailInvalid": "Adresse e-mail invalide (ex. prenom.nom@entreprise.com).",
  "adminUsers.emailInvalidTitle": "E-mail invalide",
  "adminUsers.fieldEmail": "E-mail de contact (optionnel)",
  "adminUsers.emailPlaceholder": "prenom.nom@entreprise.com",
  "adminUsers.passwordModeLink":
    "Générer un lien pour que l'utilisateur définisse son mot de passe (recommandé)",
  "adminUsers.passwordModeManual": "Définir un mot de passe initial temporaire",
  "adminUsers.createdTitle": "Utilisateur créé",
  ...
  "adminUsers.resetLinkFailed": "Échec de la génération du lien",
  ...
  "adminUsers.copyFailed": "Copie impossible",
  "adminUsers.copyFailedBody": "Sélectionnez le lien et copiez-le manuellement.",
  "adminUsers.disableBlockedTitle": "Désactivation impossible",
  "adminUsers.disableBlockedSelf": "Vous ne pouvez pas désactiver votre propre compte.",
  ...
  "adminUsers.disablePartialTitle": "Statut mis à jour partiellement",
  ...
  "adminUsers.disabledTitle": "Utilisateur désactivé",
  "adminUsers.enabledTitle": "Utilisateur réactivé",
  "adminUsers.disabledBody": "Le compte « {username} » ne peut plus se connecter.",
  "adminUsers.enabledBody": "Le compte « {username} » peut de nouveau se connecter.",
  "adminUsers.disableFailed": "Échec de la désactivation",
  "adminUsers.enableFailed": "Échec de la réactivation",
  "adminUsers.filterByStatus": "Statut",
  "adminUsers.statusAll": "Tous",
  "adminUsers.statusActive": "Actifs",
  "adminUsers.statusDisabled": "Désactivés",
  "adminUsers.badgeDisabled": "Désactivé",
  "adminUsers.resetPassword": "Réinitialiser le mot de passe",
  "adminUsers.enableUser": "Réactiver",
  "adminUsers.disableUser": "Désactiver",
  "adminUsers.confirmDisableTitle": "Désactiver l'utilisateur ?",
  "adminUsers.confirmEnableTitle": "Réactiver l'utilisateur ?",
  ...
  "adminUsers.resetLinkNewTitle": "Utilisateur créé — lien d'activation",
  "adminUsers.resetLinkTitle": "Lien de réinitialisation du mot de passe",
  "adminUsers.close": "Fermer",
  ...
  "adminUsers.resetLinkLabel": "Lien de réinitialisation",
  "adminUsers.linkCopied": "Lien copié",
  "adminUsers.copyLink": "Copier le lien",
  "adminUsers.sendByEmail": "Envoyer par e-mail à {email}",
  ...
  "adminHistory.account.renameUser": "Renommage",
  "adminHistory.account.deleteUser": "Suppression",
  "adminHistory.account.disableUser": "Désactivation",
  "adminHistory.account.enableUser": "Réactivation",
  "adminHistory.account.passwordResetLink": "Lien de réinitialisation",
  "adminHistory.account.actor": "Par",
  "adminHistory.account.target": "Compte",
