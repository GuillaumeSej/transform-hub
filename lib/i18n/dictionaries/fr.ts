...
const fr: Record<string, string> = {
  ...
  "leverDetail.trajectory.gains": "Gains annualisés (récurrents)",
  "leverDetail.trajectory.oneOffGains": "Gains ponctuels (non comptés)",
  "leverDetail.trajectory.opexRec": "OPEX récurrent (chaque période)",
  ...
  "chart.waterfall.increase": "Hausse",
  "chart.waterfall.decrease": "Baisse",
