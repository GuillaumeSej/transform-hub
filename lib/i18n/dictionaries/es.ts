...
const es: Record<string, string> = {
  ...
  "leverDetail.netGains": "Ganancias netas (brutas − CAPEX)",
  ...
  "chart.waterfall.drill.intro.target":
    "Objetivo reprevisto = realizado + pendiente (mismas cifras que « Realización de ahorros »).",
  "chart.waterfall.drill.intro.opexRec":
    "OPEX recurrente anual de las palancas activas, por naturaleza de impacto. Fuera del objetivo.",
  "chart.waterfall.note":
    "Plan inicial y reprevisto = ganancias anualizadas. Objetivo reprevisto = realizado + pendiente (igual que el gráfico de realización de ahorros). OPEX recurrente: coste anual, fuera del objetivo. Palancas canceladas excluidas de los totales.",
