...
const es: Record<string, string> = {
  ...
  "leverDetail.trajectory.gains": "Ganancias anualizadas (recurrentes)",
  "leverDetail.trajectory.oneOffGains": "Ganancias puntuales (no contabilizadas)",
  "leverDetail.trajectory.opexRec": "OPEX recurrente (cada período)",
  ...
  "chart.waterfall.increase": "Aumento",
  "chart.waterfall.decrease": "Disminución",
  "chart.waterfall.note":
    "Total esperado = reproyectado − retrasos − costes. Palancas canceladas excluidas de los totales.",
