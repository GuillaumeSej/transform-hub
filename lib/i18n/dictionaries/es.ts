...
const es: Record<string, string> = {
  ...
  "chart.waterfall.step.initial": "Plan inicial (anualizado)",
  "chart.waterfall.step.reforecast": "Reprevisto (anualizado)",
  "chart.waterfall.step.cancelled": "Cancelado",
  "chart.waterfall.step.target": "Neto reprevisto (objetivo)",
  ...
  "chart.waterfall.note":
    "Neto anualizado = ganancia bruta − OPEX recurrente (el CAPEX y los costes puntuales se siguen aparte). Neto reprevisto = realizado + pendiente (idéntico al gráfico « Realización de ahorros »). Palancas canceladas excluidas de los totales.",
