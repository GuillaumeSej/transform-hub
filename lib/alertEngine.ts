...
export function generateAlerts(
  ...
  for (const u of underperf) {
    ...
    auto.push({
      ...
      i18n: {
        titleKey: "alerts.auto.delay.title",
        descKey: "alerts.auto.delay.desc",
        vars: {
          name: u.name,
          late: u.lateActionsCount,
          total: totalActions,
  ...
  for (const da of depAlerts) {
    ...
    auto.push({
      ...
      desc: da.message,
      i18n: {
        titleKey: "alerts.auto.dependency.title",
        descKey: `dependency.alert.${da.type}`,
